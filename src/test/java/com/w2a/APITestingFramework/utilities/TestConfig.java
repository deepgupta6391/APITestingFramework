...
public class TestConfig{
	...
	public static String from = "deep.gupta.6391@gmail.com";
	public static String password = "Nirankar@123";
	public static String[] to ={"jitengupta271@gmail.com","guptaak61@rediffmail.com"};
